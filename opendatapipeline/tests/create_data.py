...
def setup_files():
    ...
    large_df = pd.concat([df1] * 60000)  # Repeat 60000 times to get data more than 5 mb
    ...
    xlsx_file_path = os.path.join(absolute_path, "test_files", "data1.xlsx")
    xlsx_file_path_2 = os.path.join(absolute_path, "test_files", "data2.xlsx")
    empty_path = os.path.join(absolute_path, "test_files", "empty_file.csv")
    large_csv_file_path = os.path.join(absolute_path, "test_files", "large_data.csv")

    paths = [csv_file_path, csv_file_path_2, csv_file_path_3,
             csv_file_path_4, xlsx_file_path, xlsx_file_path_2, large_csv_file_path,
             empty_path]
    for path in paths:
    ...
    df2.to_excel(xlsx_file_path_2, index=False)
