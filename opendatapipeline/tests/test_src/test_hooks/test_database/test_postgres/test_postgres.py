...
json_file_path = os.path.join(os.path.abspath(os.path.join(__file__, "../../../..")), "test_configurations",
                              "test_hooks", "postgres_creds.json")
...
class TestPostgres(unittest.TestCase):
    ...
    def test_fetch_data_with_vpn(self):
        catalog = "sakila.actor" if connection_details['database'] is None else "actor"
    ...
    def test_fetch_data_with_non_existing_table_with_vpn(self):
        catalog = "sakila.actor_table" if connection_details['database'] is None else "actor_table"
    ...
    def test_get_columns_with_vpn(self):
        schema_table = "public.actor"
        actual_result = SqlAlchemy().get_columns(connection_details, schema_table)
